...
async def start_watch(call: types.callback_query):
    ...
    q = await bot.send_message(call.message.chat.id, f"""<b>⚠️ ДОСТУП ЗАКРЫТ</b>
...
<b>Канал 5</b> - {name_channel_4}""", parse_mode='html',reply_markup=markup,disable_web_page_preview=True)
    await asyncio.sleep(14400)
    await bot.delete_message(chat_id=call.message.chat.id, message_id=q.message_id)
...
async def check(call: types.callback_query):
    m1 = await bot.send_message(call.message.chat.id, '⏳ Ожидайте. Идёт проверка подписки.')
    ...
    if (proverka1 == 'member' and proverka2 == 'member' and proverka3 == 'member' and proverka4 == 'member' and proverka5 == 'member') or proverka1 == 'administrator' or proverka2 == 'administrator' or proverka3 == 'administrator' or proverka4 == 'administrator' or proverka5 == 'administrator' or proverka1 == 'creator' or proverka2 == 'creator' or proverka3 == 'creator'  or proverka4 == 'creator' or proverka5 == 'creator': #Человек прошел все 5 проверки
        ...
        markup_2.add(bat_b)
        m2 = await bot.send_message(call.message.chat.id, '✅ ДОСТУП ОТКРЫТ\n\n'
