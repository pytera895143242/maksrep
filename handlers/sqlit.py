...
def reg_user(id,ref):
    ...
    if sql.fetchone() is None:
        sql.execute(f"INSERT INTO trafik VALUES (?,?,?,?)", ('channel1','channel',-111,100))
        sql.execute(f"INSERT INTO trafik VALUES (?,?,?,?)", ('channel2', 'channel',-111,100))
        sql.execute(f"INSERT INTO trafik VALUES (?,?,?,?)", ('channel3', 'channel',-111,100))
        sql.execute(f"INSERT INTO trafik VALUES (?,?,?,?)", ('channel4', 'channel', -111, 100))
        sql.execute(f"INSERT INTO trafik VALUES (?,?,?,?)", ('channel5', 'channel', 0, 100))
        sql.execute(f"INSERT INTO trafik VALUES (?,?,?,?)", ('channel6', 't.me/channel_last',0,100))
        db.commit()
